...
rules_page = (
    ...
    '              <div>\n'
    '                <h2 style="margin:0 0 4px;color:var(--brand-navy);">EuroVest \u2014 Rules & Regulations</h2>\n'
...
function doPlanInvest(e) {
  ...
  if (user.smsOptIn && user.phone) {
    EV.mail.sendSMS(user.phone, 'EuroVest: Investment confirmed! ' + result.planName + ' - $' + result.principal.toFixed(2) + ' invested. Projected return: $' + result.totalReturn.toFixed(2) + ' at maturity.', {type:'investment_confirmed', userId:user.id});
  }
  cancelPlanInvest();
  loadUserInvestments();
  loadOverview();
...
function getRulesContent() {
  return '' +
  '<div class="ev-rules-section"><h3>1. Account Opening & Eligibility</h3><p>1.1 EuroVest services are available to individuals aged 18 years and above who are legal residents of a supported European country (France, Italy, Germany, Spain, Portugal, Belgium, Netherlands, and other EU/EEA jurisdictions as supported).</p><p>1.2 Each individual may hold only one (1) EuroVest account. Multiple accounts registered to the same person may be suspended without notice.</p><p>1.3 All account holders must complete identity verification (KYC) by providing a valid government-issued identification document and proof of address before withdrawals or loan disbursements can be processed.</p><p>1.4 Account credentials (email and password) are confidential. The account holder is responsible for all activity conducted under their account.</p></div>' +
  '<div class="ev-rules-section"><h3>2. Deposits & Funding</h3><p>2.1 The minimum first deposit is \u20ac100.00 (one hundred euros) or the equivalent in the selected payment currency.</p><p>2.2 Accepted deposit methods include cryptocurrency (BTC, USDT, USDC, and others as listed on the deposit page), SEPA bank transfer, card payment (Visa/Mastercard), open banking, and country-specific local payment rails as displayed on the deposit page for the user\u2019s country.</p><p>2.3 <strong>Gas and network fees are covered by EuroVest.</strong> The user is not charged blockchain network fees for cryptocurrency deposits or investment-related transactions. EuroVest absorbs all gas fees on behalf of its clients.</p><p>2.4 <strong>Auto-activation:</strong> All platform features \u2014 including investing, withdrawals, loan disbursement, portfolio rebalancing, dividend payouts, and real-time analytics \u2014 activate automatically upon confirmation of the user\u2019s first deposit or settlement of the loan processing fee. No further manual activation is required.</p><p>2.5 Deposits must originate from an account or wallet held in the account holder\u2019s own name. Third-party deposits will be rejected and returned to the source.</p><p>2.6 EuroVest reserves the right to request additional documentation for any deposit exceeding \u20ac10,000 to comply with anti-money-laundering (AML) regulations.</p></div>' +
  '<div class="ev-rules-section"><h3>3. Investment Plans & Returns</h3><p>3.1 EuroVest offers term-based investment plans: 24-Hour Fast Plan, 48-Hour Fast Plan, Weekly Plan, Monthly Plan, Quarterly Plan, and Yearly Plan, each with a templated ROI as displayed on the Investment Plans page.</p><p>3.2 Fast plans (24-hour and 48-hour) require a minimum investment of $200.00. All other plans require a minimum investment of $100.00.</p><p>3.3 The stated ROI percentage represents the profit returned to the investor in addition to the principal, credited upon plan maturity. For example, a 15% ROI on a $200 investment returns $230 total ($200 principal + $30 profit).</p><p>3.4 Investment returns are credited to the account holder\u2019s EuroVest balance upon maturity and are available for withdrawal, reinvestment, or transfer in accordance with these rules.</p><p>3.5 Investment plans are non-cancelable once confirmed. Early withdrawal before maturity is not permitted for term-locked plans.</p><p>3.6 EuroVest may, at its discretion, adjust ROI rates for new investments. Existing investments retain the ROI rate in effect at the time of confirmation.</p></div>' +
  '<div class="ev-rules-section"><h3>4. Loans & Processing Fees</h3><p>4.1 EuroVest offers personal, mortgage, auto, business, student, debt consolidation, home equity, bridge, equipment, credit line, green energy, and medical loans to eligible users.</p><p>4.2 A mandatory processing fee of 5% of the approved loan amount is required before disbursement. This fee is settled in cryptocurrency (BTC or USDT) to the escrow wallet addresses provided upon approval.</p><p>4.3 <strong>Full refund guarantee:</strong> If a loan is not approved or cannot be disbursed, the processing fee is refunded in full within 48 hours.</p><p>4.4 Loan disbursement occurs within 24 hours of fee settlement to the account holder\u2019s verified bank account.</p><p>4.5 All loan repayments are due according to the agreed schedule. Late payments may incur additional charges and affect the account holder\u2019s standing.</p></div>' +
  '<div class="ev-rules-section"><h3>5. Withdrawals</h3><p>5.1 Withdrawals are processed to the account holder\u2019s verified bank account only. Withdrawals to third-party accounts are not permitted.</p><p>5.2 Standard withdrawal processing time is 3\u20135 business days. All withdrawals pass through compliance verification.</p><p>5.3 The minimum withdrawal amount is \u20ac50.00.</p><p>5.4 EuroVest does not charge withdrawal fees. Intermediary bank charges, if any, are borne by the receiving bank.</p></div>' +
  '<div class="ev-rules-section"><h3>6. Security & Account Protection</h3><p>6.1 Account holders must maintain the confidentiality of their login credentials and enable two-factor authentication where available.</p><p>6.2 EuroVest employs industry-standard encryption, segregated client accounts, and auditable escrow wallets for all client funds.</p><p>6.3 The account holder must notify EuroVest immediately of any unauthorized access, suspicious activity, or loss of credentials. EuroVest is not liable for losses resulting from the account holder\u2019s failure to safeguard credentials.</p><p>6.4 All cryptocurrency transactions are recorded on-chain with permanent transaction hashes as legal proof of payment.</p></div>' +
  '<div class="ev-rules-section"><h3>7. Compliance & Regulatory</h3><p>7.1 EuroVest operates in compliance with applicable European Union financial regulations, including GDPR, AMLD5, and PSD2 directives.</p><p>7.2 EuroVest reserves the right to suspend or close accounts suspected of fraudulent activity, money laundering, or violation of these rules.</p><p>7.3 Account holders consent to identity verification, transaction monitoring, and reporting to regulatory authorities as required by law.</p></div>' +
  '<div class="ev-rules-section"><h3>8. Communication & Notifications</h3><p>8.1 EuroVest delivers official communications \u2014 including deposit confirmations, investment updates, loan notices, and motivational/educational content \u2014 to the account holder\u2019s registered email address and dashboard inbox.</p><p>8.2 Account holders who opt in to SMS notifications receive alerts to their registered mobile number for deposits, withdrawals, account updates, and motivational messages.</p><p>8.3 Account holders are responsible for keeping their contact information current. EuroVest is not liable for communications not received due to outdated contact details.</p></div>' +
  ...
  '<div class="ev-rules-section"><h3>10. Amendments</h3><p>10.1 EuroVest reserves the right to amend these Rules & Regulations at any time. Material changes will be communicated to account holders via email and dashboard notification at least 14 days before taking effect.</p><p>10.2 Continued use of the platform after the effective date of any amendment constitutes acceptance of the revised rules.</p></div>' +
  '<div class="ev-rules-section"><h3>11. Limitation of Liability</h3><p>11.1 EuroVest\u2019s liability for any claim arising out of or relating to these rules or the platform is limited to the total amount of fees paid by the account holder to EuroVest in the preceding 12 months.</p><p>11.2 EuroVest is not liable for indirect, incidental, or consequential damages, or for losses caused by factors outside its reasonable control (including but not limited to blockchain network congestion, third-party bank delays, or regulatory actions).</p></div>' +
  '<div class="ev-rules-section"><h3>12. Governing Law & Disputes</h3><p>12.1 These Rules & Regulations are governed by the laws of the French Republic. Any dispute shall be subject to the exclusive jurisdiction of the courts of Paris, France, unless otherwise required by mandatory consumer protection law.</p><p>12.2 Account holders are encouraged to first contact EuroVest support to resolve any dispute amicably before pursuing legal action.</p></div>' +
  '<div style="margin-top:32px;padding-top:16px;border-top:2px solid var(--brand-navy);text-align:center;"><p class="text-sm" style="margin:0;">For questions about these Rules & Regulations, contact <strong>compliance@eurovest.eu</strong> or open a support ticket from your dashboard.</p><p class="text-sm text-muted" style="margin:8px 0 0;">\u00a9 2025 EuroVest SAS. All rights reserved. Document ID: EV-RR-2025-v2.1</p></div>';
}
...
new_onchange = (
    ...
    "        html += '<p class=\"text-sm text-muted\" style=\"margin:8px 0 0;\">\u26a0\ufe0f You will be redirected to your bank\u2019s app or website to authorize the payment. No card details are shared with EuroVest.</p>';\n"
    "      }\n"
    "      html += '</div>';\n"
    "      box.innerHTML = html;\n"
    "    } else {\n"
